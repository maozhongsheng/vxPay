...
public class WXPayConstants {
    /*
        自定义内容     */
    /*支付*/
    public static final String APP_ID = "wxe4d5046e8cc8ed29";//appid  填写你们自己的
    public static final String MCH_ID = "1611605912";//商家ID   填写你们自己的
    ...
    public static final String CALLBACK_URL = "https://127.0.0.1/ad-applets/callBack";//微信服务器调用支付结果通知路径
    public static final String PATERNER_KEY = "123456qwertyuiopasdfghjklzxcvbnm";//商户key秘钥   填写你们自己的
    /*退款*/
